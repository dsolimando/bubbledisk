...
class AmazonCoverArtSearch (object):
	...
	def search (self, st_artist, st_album, on_search_completed_callback, *args):
		self.searching = True
		self.cancel = False
	...
	def on_search_completed (self, result):
		self.on_search_completed_callback (self, result, *self.args)
		self.searching = False
	...
	def get_best_match_urls (self, search_results):
		...
		try:
			...
			if best_match:
				...
				return [best_match.ImageUrlMedium]
			else:
				return []
